...
var printTable = function printTable(actions) {
  ...
  return "".concat(sprintf("\t%".concat(longestMessage + 3, "s\t%s"), "TYPE", "PROPS"), "\n").concat(actions.map(printAction).join("\n"));
};
...
function () {
  ...
  _createClass(ActionMatcher, [{
    ...
    value: function and(otherPredicate, otherErrorMessage) {
      this.destroy();
      return new ActionMatcher(allPass([this.predicate, otherPredicate]), "".concat(this.errorMessage, " and ").concat(otherErrorMessage), this.store, this.timeout);
    }
  }, {
    key: "ofType",
    value: function ofType(type) {
      return this.and(propEq("type", type), "of type '".concat(type, "'"));
    }
  }, {
    key: "matching",
    value: function matching(objectOrPredicate) {
      if (typeof objectOrPredicate === "function") {
        ...
        return this.and(equals(objectOrPredicate), "equal to ".concat(trySerialize(objectOrPredicate)));
      }
    }
  }, {
    key: "asserting",
...
function (_ActionMatcher) {
  ...
  _createClass(NotActionMatcher, [{
    ...
    value: function and(otherPredicate, otherErrorMessage) {
      this.destroy();
      return new NotActionMatcher(allPass([this.predicate, otherPredicate]), "".concat(this.errorMessage, " and ").concat(otherErrorMessage), this.store, this.timeout);
    }
  }]);
...
function () {
  ...
  _createClass(StateMatcher, [{
    ...
    value: function matching(expectedState) {
      this.destroy();
      return new StateMatcher(equals(expectedState), "equaling ".concat(JSON.stringify(expectedState)), this.store, this.timeout);
    }
  }, {
    key: "withSubtree",
...
function (_StateMatcher) {
  ...
  _createClass(SelectingStateMatcher, [{
    ...
    value: function matching(expectedState) {
      this.destroy();
      return new SelectingStateMatcher(this.selector, equals(expectedState), "substate equaling ".concat(JSON.stringify(expectedState)), this.store, this.timeout);
    }
  }, {
    key: "withSubtree",
    value: function withSubtree(selector) {
      this.destroy();
      return SelectingStateMatcher.empty(pipe(this.selector, selector), this.store, this.timeout);
    }
  }, {
    key: "test",
    value: function test() {
