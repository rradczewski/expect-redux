...
function (_Promise) {
  ...
  _createClass(MatcherPromise, [{
    ...
    value: function and(matcherPromise) {
      ...
      ramda.allPass([this[predicateSymbol], matcherPromise[predicateSymbol]]), // $FlowFixMe
    ...
    value: function ofType(type) {
      return this.and(MatcherPromise.create(ramda.propEq("type", type), "of type '".concat(type, "'"), // $FlowFixMe
      this[storeSymbol]));
    }
  }, {
    key: "matching",
    value: function matching(objectOrPredicate) {
      if (typeof objectOrPredicate === "function") {
        ...
        return this.and(MatcherPromise.create(ramda.equals(objectOrPredicate), "equal to ".concat(trySerialize(objectOrPredicate)), // $FlowFixMe
        this[storeSymbol]));
      }
    }
  }, {
